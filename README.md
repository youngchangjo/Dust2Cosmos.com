...
우주먼지의 출시 예정 3.0 소개 페이지. 영문 `/`, 한국어 `/ko/`, 기존 `/privacy/`·`/support/`를 제공하는 정적 사이트입니다. 시스템 설정과 무관하게 **다크 테마만** 제공합니다. 2026-09-24 갱신: 실제 3.0 캡처, 편집 선정 월계관, 현행 무료/Pro 사양과 SEO/GEO 정보를 반영합니다. 운영 도메인 https://dust2cosmos.com 에 배포했으며 검토본과 근거는 기존 비공개 Sites 문서함에 게시합니다. 3.0 앱 출시는 별도입니다.
